                    ...
                    <li>
                        <a href="<?php echo url_for('person/detail?id='.$result['personid']) ?>" class="ui-link-inherit">
                            ...
                            <?php if ($result['average']): ?>
                                <span class="results-rank-title">Average</span>&nbsp;<?php include_partial('global/title_record', array('result' => $result, 'type' => 'average')) ?>&nbsp;<?php echo $result['average'] ?>&nbsp;
                            <?php endif ?>
                            <span class="results-rank-title">Best</span>&nbsp;<?php include_partial('global/title_record', array('result' => $result, 'type' => 'single')) ?>&nbsp;<?php echo $result['best'] ?><br />
