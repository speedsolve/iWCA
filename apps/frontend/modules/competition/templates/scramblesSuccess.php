                     ...
                     <?php foreach ($groups as $group): ?>
                        <li>
                             <?php if (isset($shortId)): ?>
                                 ...
                                 <div class="scramble_image"><img src="http://iwca.jp/images/vcube/visualcube.php?size=<?php echo $size ?>&pzl=<?php echo $shortId ?>&alg=<?php echo $group['scramble'] ?>&sch=wrgyob&bg=t&fmt=png"></div>
                             <?php endif; ?>
